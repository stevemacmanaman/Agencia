...
--
-- Host: localhost:3307
-- Generation Time: Nov 20, 2019 at 12:26 AM
...
(1, 'Steve', 'as@correo.com', 'Excelente viaje'),
(2, 'Jazmin', 'jas@correo.com', 'd a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by'),
(3, 'lucy', 'axxxs@correo.com', 'd a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes d a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by'),
(4, 'robertio', 'as@correo.com', 'probando async await');
